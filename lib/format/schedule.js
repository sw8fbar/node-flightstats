...
function getAirline(airline){
  var airline = airlines.filter(function(element){
...
function getAirport(airport){
  var airport = airports.filter(function(element){
...
function formatFlight( flight ) {
  ...
  var data = {
    ...
    arrival: {
      ...
      airport: getAirport(flight.arrivalAirportFsCode),
    },
    departure: {
      ...
      airport: getAirport(flight.departureAirportFsCode),
    },
